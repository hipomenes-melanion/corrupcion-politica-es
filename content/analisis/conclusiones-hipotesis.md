...
```mermaid
flowchart TD
    H["🔮 CUATRO HIPÓTESIS DE TRABAJO"]
    
    H1["🇩🇴 Hipótesis 1: Dominicana"]
    H2["⏳ Hipótesis 2: Cronología"]
    H3["📈 Hipótesis 3: Servinabar"]
    H4["👤 Hipótesis 4: Superjefe"]
    
    H --> H1 & H2 & H3 & H4
    
    H1 --> D1["Vuelos privados y tránsito<br>de efectivo de Begoña Gómez"]
    H2 --> D2["Comisiones mensuales de Azvi<br>frente a descarrilamiento en Adamuz"]
    H3 --> D3["Sociedad Servinabar como caja B<br>de Santos Cerdán con testaferros"]
    H4 --> D4["Financiación ilegal desde Ferraz<br>y asalto a la cúpula de la SEPI"]
    
    style H fill:#4a148c,stroke:#311b92,stroke-width:2px,color:#fff
    style H1 fill:#1a237e,stroke:#0d47a1,stroke-width:1.5px,color:#fff
    style H2 fill:#006064,stroke:#004d40,stroke-width:1.5px,color:#fff
    style H3 fill:#1b5e20,stroke:#33691e,stroke-width:1.5px,color:#fff
    style H4 fill:#b71c1c,stroke:#880e4f,stroke-width:1.5px,color:#fff
    
    style D1 fill:#f5f5f5,stroke:#ccc,color:#000
    style D2 fill:#f5f5f5,stroke:#ccc,color:#000
    style D3 fill:#f5f5f5,stroke:#ccc,color:#000
    style D4 fill:#f5f5f5,stroke:#ccc,color:#000
```
